...
# matmul_bench.py #
This file [matmul_bench.py](https://github.com/AlphasCodes/DeepLearning/blob/master/matmul_bench.py) contains code to measure TFLOPs. I found the code in the internet.
